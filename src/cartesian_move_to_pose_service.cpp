...
#include "robot_common_manip/srv/cartesian_move_to_pose.hpp"
...
public:
    ...
    : Node("cartesian_path_planner")
  {
    ...
    service_ = this->create_service<robot_common_manip::srv::CartesianMoveToPose>(
      "plan_cartesian_path",
...
private:
  rclcpp::Service<robot_common_manip::srv::CartesianMoveToPose>::SharedPtr service_;
